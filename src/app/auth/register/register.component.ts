...
export class RegisterComponent implements OnInit {
  ...
  shouldShowErrorForControl(controlName: string, sourseGroup: FormGroup = this.registerFormGroup) {
    return sourseGroup.controls[controlName].touched && sourseGroup.controls[controlName].invalid
  }
